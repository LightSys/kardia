$Version=2$
disbursements_summary "widget/page"
    {
    title = "i18n:Disbursements Summary Report";
    width=580;
    height=525;
	...
	qy_cn "widget/connector" { event=Query; target=f_period; action=SetValue; Value=runclient(:disbursements_summary:period); }

	vb2 "widget/vbox"
	    {
	    x=32;y=8;width=514;height=468;
	    spacing=4;
	    lbl_tb "widget/label" { height=30; font_size=16; text="i18n:Disbursements Summary - Report Options:"; align=center; }
	...
	vb3 "widget/vbox"
		...
		rpt_print "widget/textbutton"
		    ...
		    rpt_print_cn "widget/connector" { event="Click"; target="rpt_form"; action="Submit"; Target=runclient("disbursements_summary"); NewPage=runclient(1); Source=runclient("/apps/kardia/modules/disb/disbursements_summary.rpt"); Width=runclient(800); Height=runclient(600); }
		    }
		rpt_cancel "widget/textbutton"
		    {
		    width=90;
		    text="i18n:Cancel";
		    rpt_cancel_cn "widget/connector" { event="Click"; target="disbursements_summary"; action="Close"; }
		    }
		}
	    }
	}
