$Version=2$
disbursements_matrix "widget/page"
    {
	...
	qy_cn "widget/connector" { event=Query; target=f_yearperiod; action=SetValue; Value=runclient(:disbursements_matrix:year_period); }

	vb2 "widget/vbox"
	    {
	    x=32;y=8;width=514;height=468;
	    spacing=4;
	    lbl_tb "widget/label" { height=30; font_size=16; text="Disbursements Matrix - Report Options:"; align=center; }
	...
	vb3 "widget/vbox"
		...
		rpt_print "widget/textbutton"
		    ...
		    rpt_print_cn "widget/connector" { event="Click"; target="rpt_form"; action="Submit"; Target=runclient("disbursements_matrix"); NewPage=runclient(1); Source=runclient("/apps/kardia/modules/disb/disbursements_matrix.rpt"); Width=runclient(800); Height=runclient(600); }
		    }
		rpt_cancel "widget/textbutton"
		    {
		    width=90;
		    text="Cancel";
		    rpt_cancel_cn "widget/connector" { event="Click"; target="disbursements_matrix"; action="Close"; }
		    }
		}
	    }
	}
