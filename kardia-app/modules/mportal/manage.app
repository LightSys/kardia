...
// manage.app for Missionary Portal in Kardia.
//
// Copyright (C) 2016-2017 LightSys Technology Services, Inc.
// Written 04-Apr-2017 by Greg Beeley
//
...
index "widget/page"
    ...
    // Security control -- only users with the "kardia:portal_manage"
    // endorsement are allowed to use this application.
    //
    require_endorsements = "kardia:portal_manage";
    endorsement_context = "kardia";

    // Main interface
    //
    mportalmanage "widget/component"
	{
	x=0; y=0;
