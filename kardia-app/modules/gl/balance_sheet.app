...
balance_sheet "widget/page"
	...
	vb2 "widget/vbox"
		...
		year_sel_cn "widget/connector"
		    ...
		    target=f_start;
		    action=SetSQL;
		    sql = runclient("select :a_period + ' - ' + :a_period_desc, :a_period, :a_summary_only from subtree /apps/kardia/modules/gl/periods.qyt/" + :balance_sheet:ledger + "/" + :rpt_form:year_period + "|" + :balance_sheet:ledger + " order by :a_period asc having :a_summary_only = 0");
		    }
		}
