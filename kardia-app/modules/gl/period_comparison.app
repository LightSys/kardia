...
period_comparison "widget/page"
	...
	vb2 "widget/vbox"
	    ...
	    f_onlycostctr "widget/component" { width=350; height=24; path="/apps/kardia/modules/base/editbox_tree.cmp"; field="only_funds"; popup_source=runserver("/apps/kardia/modules/gl/costctrs.qyt/" + :this:ledger + "/"); popup_text="Choose Cost Center:"; text="Only Funds:"; attach_point=editbox; label_width=120; empty_desc="optional, comma separated"; }
	    f_exclcostctr "widget/component" { width=350; height=24; path="/apps/kardia/modules/base/editbox_tree.cmp"; field="excl_funds"; popup_source=runserver("/apps/kardia/modules/gl/costctrs.qyt/" + :this:ledger + "/"); popup_text="Choose Cost Center:"; text="Exclude Funds:"; attach_point=editbox; label_width=120; empty_desc="optional, comma separated"; }
	    f_onlyaccts "widget/component" { width=350; height=24; path="/apps/kardia/modules/base/editbox_tree.cmp"; field="only_accts"; popup_source=runserver("/apps/kardia/modules/gl/costctrs.qyt/" + :this:ledger + "/"); popup_text="Choose Cost Center:"; text="Only Accounts:"; attach_point=editbox; label_width=120; empty_desc="optional, comma separated"; }
	    f_exclaccts "widget/component" { width=350; height=24; path="/apps/kardia/modules/base/editbox_tree.cmp"; field="excl_accts"; popup_source=runserver("/apps/kardia/modules/gl/costctrs.qyt/" + :this:ledger + "/"); popup_text="Choose Cost Center:"; text="Exclude Accounts:"; attach_point=editbox; label_width=120; empty_desc="optional, comma separated"; }
