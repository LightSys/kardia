...
payroll_register "widget/page"
    {
    title = "i18n:Payroll Register Report";
    width=580;
    height=525;
	...
	vb2 "widget/vbox"
	    ...
	    spacing=4;
	    lbl_tb "widget/label" { height=30; font_size=16; text="i18n:Payroll Register - Report Options:"; align=center; }
	    ...
	    f_group "widget/component" { width=350; height=24; path="/sys/cmp/smart_field.cmp"; field='groupid'; ctl_type=dropdown; text='i18n:Pay Group:'; sql=runserver("select :a_payroll_group_name + ' (' + :a_payroll_group_id + ')', :a_payroll_group_id from /apps/kardia/data/Kardia_DB/a_payroll_group/rows where :a_ledger_number = " + quote(:this:ledger)); form=rpt_form; label_width=120; }
