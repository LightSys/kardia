...
deposit_summary "widget/page"
    ...
    require_one_endorsement="kardia:dep_manage","kardia:dep";
	...
	qy_cn "widget/connector" { event=Query; target=f_period; action=SetValue; Value=runclient(:deposit_summary:period); }

	vb2 "widget/vbox"
	    {
	    x=32;y=8;width=514;height=468;
	    spacing=4;
	    lbl_tb "widget/label" { height=30; font_size=16; text="Deposit Summary - Report Options:"; align=center; }
	...
	vb3 "widget/vbox"
		...
		rpt_print "widget/textbutton"
		    ...
		    rpt_print_cn "widget/connector" { event="Click"; target="rpt_form"; action="Submit"; Target=runclient("deposit_summary"); NewPage=runclient(1); Source=runclient("/apps/kardia/modules/rcpt/deposit_summary.rpt"); Width=runclient(800); Height=runclient(600); }
		    }
		rpt_cancel "widget/textbutton"
		    {
		    width=90;
		    text="Cancel";
		    rpt_cancel_cn "widget/connector" { event="Click"; target="deposit_summary"; action="Close"; }
		    }
		}
	    }
	}
