...
gift_entry "widget/page"
    ...
    width=1000;
    height=700;
    widget_template = "/apps/kardia/tpl/kardia-system.tpl", runserver("/apps/kardia/tpl/" + user_name() + ".tpl"), "/apps/kardia/modules/rcpt/gift_new.tpl";
	...
	path = "/apps/kardia/modules/rcpt/gift_entry_new.cmp";
