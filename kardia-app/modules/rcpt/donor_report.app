...
//    list_type "report/parameter" { type=string; default="S"; }
	...
	vb2 "widget/vbox"
		...
		col1_vbox "widget/vbox"
		    ...
		    f_incfunds "widget/component" { width=340; height=24; path="/apps/kardia/modules/base/editbox_tree.cmp"; field="include_funds"; popup_source=runserver("/apps/kardia/modules/gl/funds.qyt/" + :this:ledger + "/"); popup_text="Choose Fund:"; text="Only Funds:"; attach_point=editbox; empty_desc = "optional"; label_width=120; }
		    f_excfunds "widget/component" { width=340; height=24; path="/apps/kardia/modules/base/editbox_tree.cmp"; field="exclude_funds"; popup_source=runserver("/apps/kardia/modules/gl/funds.qyt/" + :this:ledger + "/"); popup_text="Choose Fund:"; text="Exclude Funds:"; attach_point=editbox; empty_desc = "optional"; label_width=120; }
