...
donation_detail "widget/page"
	...
	vb2 "widget/vbox"
	    ...
	    spacing=4;
	    lbl_tb "widget/label" { height=30; font_size=16; text="Cash Receipts Detail Options:"; align=center; }
	    ...
	    f_line "widget/component" { x=10; width=400; height=24; path="/sys/cmp/smart_field.cmp"; field="show_line_items"; ctl_type='checkboxleft'; text="Show Designations"; form=rpt_form; label_width=120; }
