...
annual_statement "widget/page"
    {
    title = "i18n:Annual Giving Statement for Donor";
    width=580;
    height=553;
	...
	vb2 "widget/vbox"
	    ...
	    spacing=4;
	    lbl_opt "widget/label" { height=30; font_size=16; text="i18n:Annual Giving Statement Options:"; align=center; }
	    ...
	    f_period "widget/component" { width=350; height=24; path="/sys/cmp/smart_field.cmp"; field="year_period"; text="i18n:Year:"; empty_desc = "i18n:required"; ctl_type=dropdown; sql=runserver("select :a_period_desc + ' - ' + :a_period, :a_period from /apps/kardia/data/Kardia_DB/a_period/rows where :a_parent_period is null and :a_ledger_number = " + quote(:this:ledger) + " order by :a_start_date desc"); label_width=120; }
