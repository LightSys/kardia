...
wholePage "widget/page" {
	...
	sidebarButton1 "widget/textbutton" {
		...
		cn1 "widget/connector" {
			event="Click"; target="ptnrQueryWindow"; action="SetVisibility";
		}
	}
	sidebarButton2 "widget/textbutton" {
		...
		cn2 "widget/connector" {
			event="Click"; target="ptnrChurchWindow"; action="SetVisibility";
		}
	}
		...
		osrc1 "widget/osrc" {
			...
			form1 "widget/form" {
				...
				ptnr_occupation_code_c_data "widget/dropdown" {
					x=430; y=80; width=160; height=15;
					numdisplay=5;
				...
				churchButton "widget/textbutton" {
					x=430; y=107; height=25; width=160;
					fgcolor1="#000000"; fgcolor2="#cfcfcf";
				...
				relationButton "widget/textbutton" {
					x=430; y=135; height=25; width=160;
					fgcolor1="#000000"; fgcolor2="#cfcfcf";
					text="Relationships";
					tristate="no";
				...
				dateBtn "widget/datetime" {
					x=430; y=162; height=20; width=160;
					fgcolor="#000000"; bgcolor="#c0c0c0";
					fieldname="ptnr_date_of_birth_d";
				}

				textarea1 "widget/textarea" {
					x=430; y=190; height=70; width=160;
					bgcolor=white;
					fieldname="ptnr_academic_title_c";
					style="lowered";
				}
		...
		osrcChurch "widget/osrc" {
			...
			formChurch "widget/form" {
				...
				ptnr_denomination_code_c_data "widget/dropdown" {
					x=180; y=120; width=230; height=15; 
		...
		Treeview_pane "widget/pane" {
			...
			Tree_scroll "widget/scrollpane" {
				...
				Tree "widget/treeview" {
					x=0; y=1; width=20000;
					source = "javascript:ptnrQueryWindow";
				}
			}
		}
	}
