...
e_workflow "application/filespec"
    ...
    annotation = "CSV Data for e_workflow";
    key_is_rowid = yes;
    new_row_padding = 8;
    ...
    e_workflow_start "filespec/column" { type=datetime; id=3; }
    e_workflow_trigger_id "filespec/column" { type=integer; id=4; }
    e_workflow_trigger_type "filespec/column" { type=string; id=5; }
    e_workflow_step_id "filespec/column" { type=integer; id=6; }
    e_workflow_step_start "filespec/column" { type=datetime; id=7; }
    e_workflow_step_trigger_id "filespec/column" { type=integer; id=8; }
