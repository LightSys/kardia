...
e_engagement_step "application/filespec"
    ...
    annotation = "CSV Data for e_engagement_step";
    key_is_rowid = yes;
    new_row_padding = 8;
    ...
    e_step_name "filespec/column" { type=string; id=3; }
    e_step_description "filespec/column" { type=string; id=4; }
    e_step_sequence "filespec/column" { type=integer; id=5; }
