$Version=2$
a_tax_filingstatus "application/filespec"
    {
    // General parameters.
    filetype = csv;
    header_row = yes;
    ...
    a_desc "filespec/column" { type=varchar(255); id=2; }
    s_created_by "filespec/column" { type=varchar(20); id=3; }
    a_ledger_number "filespec/column" { type=char(10); id=4; }
    a_payroll_item_type_code "filespec/column" { type=char(3); id=5; }
    a_filing_status "filespec/column" { type=char(1); id=6; }
