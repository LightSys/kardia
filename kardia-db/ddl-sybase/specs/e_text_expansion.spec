...
e_text_expansion "application/filespec"
    ...
    annotation = "CSV Data for e_text_expansion";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    e_exp_tag "filespec/column" { type=string; id=1; }
    e_exp_desc "filespec/column" { type=string; id=2; }
    e_exp_expansion "filespec/column" { type=string; id=3; }
