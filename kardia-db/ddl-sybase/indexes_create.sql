...
/* p_partner_key_cnt */
/* create  clustered index p_partner_key_cnt_pk on p_partner_key_cnt (p_partner_key)*/ 
/* go */


/* p_person */
/* create  clustered index p_person_clustered_pk on p_person (p_partner_key)*/ 
/* go */
...
go
/* create  clustered index p_postal_sort_clustered_idx on p_location (p_country_code, p_bulk_postal_code, p_postal_code, p_partner_key, p_location_id, p_revision_id)*/ 
/* go */
...
go
/* create  clustered index p_af_pk on p_address_format (p_address_set, p_country_code)*/ 
/* go */


/* p_address_format_set */
/* create  clustered index p_afs_pk on p_address_format_set (p_address_set)*/ 
/* go */
...
/* p_church */
/* create  clustered index p_church_pk on p_church (p_partner_key)*/ 
/* go */
...
go
/* create  clustered index p_donor_pk on p_donor (p_partner_key, a_gl_ledger_number)*/ 
/* go */
...
go
/* create  clustered index p_payee_pk on p_payee (p_partner_key, a_gl_ledger_number)*/ 
/* go */
...
go
/* create  clustered index p_staff_pk on p_staff (p_partner_key)*/ 
/* go */
...
/* p_bulk_postal_code */
/* create  clustered index p_bulk_code_pk on p_bulk_postal_code (p_country_code,p_bulk_postal_code,p_bulk_code)*/ 
/* go */


/* p_zipranges */
/* create  clustered index p_bulk_code_pk on p_zipranges (p_first_zip,p_last_zip)*/ 
/* go */


/* p_country */
/* create  clustered index p_country_code_pk on p_country (p_country_code)*/ 
/* go */
...
/* p_title */
/* create  clustered index p_title_pk on p_title (p_title)*/ 
/* go */
...
go
/* create  clustered index p_gaz_name_clustered_idx on p_gazetteer (p_feature_name, p_country_code, p_feature_type, p_feature_id)*/ 
/* go */
...
/* p_partner_sort_tmp */
/* create  clustered index p_sort_pk on p_partner_sort_tmp (p_partner_key,s_username,p_sort_session_id)*/ 
/* go */
...
go
/* create  clustered index p_dupcheck_pk on p_dup_check_tmp (p_partner_key,s_username)*/ 
/* go */
...
/* p_notification */
/* create  clustered index p_notify_pk on p_notification (p_notify_id)*/ 
/* go */
...
/* p_notification_type */
/* create  clustered index p_notify_type_pk on p_notification_type (p_notify_type)*/ 
/* go */


/* p_notification_method */
/* create  clustered index p_notify_method_pk on p_notification_method (p_notify_method)*/ 
/* go */


/* p_notification_pref */
create  index p_notify_partner_idx on p_notification_pref (p_recip_partner_key, p_notify_type, p_notify_method, p_notify_method_item)
go
/* create  clustered index p_notify_pref_pk on p_notification_pref (p_notify_type, p_notify_method, p_notify_method_item, p_recip_partner_key)*/ 
/* go */
...
go
/* create  clustered index r_grp_pk on r_group (r_group_name)*/ 
/* go */
...
go
/* create  clustered index r_rpt_pk on r_group_report (r_group_name, r_delivery_method, p_recipient_partner_key, r_report_id)*/ 
/* go */
...
go
/* create  clustered index r_param_pk on r_group_param (r_group_name, r_param_name)*/ 
/* go */
...
go
/* create  clustered index r_rparam_pk on r_group_report_param (r_group_name, r_delivery_method, p_recipient_partner_key, r_report_id, r_param_name)*/ 
/* go */
...
go
/* create  clustered index r_ps_pk on r_saved_paramset (r_paramset_id)*/ 
/* go */


/* r_saved_param */
/* create  clustered index r_psparam_pk on r_saved_param (r_paramset_id, r_param_name)*/ 
/* go */


/* a_config */
/* create  clustered index a_config_pk on a_config (a_ledger_number, a_config_name)*/ 
/* go */


/* a_analysis_attr */
/* create  clustered index a_an_attr_pk on a_analysis_attr (a_ledger_number, a_attr_code)*/ 
/* go */


/* a_analysis_attr_value */
/* create  clustered index a_an_attr_val_pk on a_analysis_attr_value (a_ledger_number, a_attr_code, a_value)*/ 
/* go */


/* a_fund_analysis_attr */
/* create  clustered index a_fund_an_attr_pk on a_fund_analysis_attr (a_ledger_number, a_attr_code, a_fund, a_hist_id)*/ 
/* go */


/* a_acct_analysis_attr */
/* create  clustered index a_acct_an_attr_pk on a_acct_analysis_attr (a_ledger_number, a_attr_code, a_account_code, a_hist_id)*/ 
/* go */
...
go
/* create  clustered index a_fund_pk on a_fund (a_fund, a_ledger_number)*/ 
/* go */


/* a_account */
/* create  clustered index a_account_pk on a_account (a_account_code, a_ledger_number)*/ 
/* go */
...
/* a_account_usage */
/* create  clustered index a_account_usage_pk on a_account_usage (a_acct_usage_code, a_ledger_number, a_account_code)*/ 
/* go */
...
/* create  clustered index a_account_usage_type_pk on a_account_usage_type (a_acct_usage_code)*/ 
/* go */


/* a_account_category */
/* create  clustered index a_account_category_pk on a_account_category (a_account_category, a_ledger_number)*/ 
/* go */


/* a_fund_acct */
/* create  clustered index a_fund_acct_pk on a_fund_acct (a_ledger_number, a_period, a_fund, a_account_code)*/ 
/* go */


/* a_period */
/* create  clustered index a_period_pk on a_period (a_period, a_ledger_number)*/ 
/* go */


/* a_period_usage */
/* create  clustered index a_account_usage_pk on a_period_usage (a_period_usage_code, a_ledger_number, a_period)*/ 
/* go */


/* a_period_usage_type */
/* create  clustered index a_period_usage_type_pk on a_period_usage_type (a_period_usage_code)*/ 
/* go */


/* a_ledger */
/* create  clustered index a_ledger_pk on a_ledger (a_ledger_number)*/ 
/* go */
...
go
/* create  clustered index a_batch_pk on a_batch (a_batch_number, a_ledger_number)*/ 
/* go */
...
go
/* create  clustered index a_trx_fund_clustered_idx on a_transaction (a_fund, a_account_code, a_ledger_number, a_batch_number, a_journal_number, a_transaction_number)*/ 
/* go */
...
go
/* create  clustered index a_trxt_fund_clustered_idx on a_transaction_tmp (a_fund, a_account_code, a_ledger_number, a_batch_number, a_journal_number, a_transaction_number)*/ 
/* go */
...
/* a_account_class */
/* create  clustered index a_account_class_pk on a_account_class (a_account_class, a_ledger_number)*/ 
/* go */


/* a_fund_class */
/* create  clustered index a_fund_class_pk on a_fund_class (a_fund_class, a_ledger_number)*/ 
/* go */


/* a_reporting_level */
/* create  clustered index a_level_pk on a_reporting_level (a_reporting_level, a_ledger_number)*/ 
/* go */
...
go
/* create  clustered index a_fund_prefix_pk on a_fund_prefix (a_fund_prefix, a_ledger_number)*/ 
/* go */
...
go
/* create  clustered index a_fund_staff_pk on a_fund_staff (a_ledger_number, a_fund, p_staff_partner_key)*/ 
/* go */


/* a_ledger_office */
/* create  clustered index a_lo_pk on a_ledger_office (a_ledger_number, p_office_partner_key)*/ 
/* go */
...
/* a_bank_recon */
/* create  clustered index a_recon_pk on a_bank_recon (a_ledger_number, a_account_code, a_statement_id)*/ 
/* go */
...
go
/* create  clustered index a_recon_item_pk on a_bank_recon_item (a_ledger_number, a_account_code, a_line_item)*/ 
/* go */


/* a_bank_recon_accts */
/* create  clustered index a_recon_accts_pk on a_bank_recon_accts (a_ledger_number, a_account_code)*/ 
/* go */
...
go
/* create  clustered index a_dim_pk on a_dimension (a_dimension, a_ledger_number)*/ 
/* go */
...
go
/* create  clustered index a_dim_item_pk on a_dimension_item (a_dimension, a_ledger_number, a_dimension_item)*/ 
/* go */
...
go
/* create  clustered index a_payroll_pk on a_payroll (a_ledger_number, a_payroll_group_id, a_payroll_id)*/ 
/* go */
...
go
/* create  clustered index a_payroll_grp_pk on a_payroll_group (a_ledger_number, a_payroll_group_id)*/ 
/* go */
...
go
/* create  clustered index a_payrolli_pk on a_payroll_import (a_payroll_id)*/ 
/* go */


/* a_payroll_item */
/* create  clustered index a_payroll_i_pk on a_payroll_item (a_ledger_number, a_payroll_group_id, a_payroll_id, a_payroll_item_id)*/ 
/* go */


/* a_payroll_item_import */
/* create  clustered index a_payrolli_i_pk on a_payroll_item_import (a_payroll_id, a_payroll_item_id)*/ 
/* go */


/* a_payroll_item_type */
/* create  clustered index a_payroll_it_pk on a_payroll_item_type (a_ledger_number, a_payroll_item_type_code)*/ 
/* go */
...
/* create  clustered index a_payroll_f_pk on a_payroll_form_group (a_ledger_number, a_payroll_form_group_name, a_payroll_form_sequence)*/ 
/* go */


/* a_tax_filingstatus */
/* create  clustered index a_filingstatus_pk on a_tax_filingstatus (a_ledger_number, a_payroll_item_type_code, a_filing_status)*/ 
/* go */


/* a_tax_table */
/* create  clustered index a_taxtable_clustered_idx on a_tax_table (a_payroll_item_type, a_ledger_number, a_start_date, a_filing_status, a_payroll_interval, a_minimum_salary)*/ 
/* go */
...
/* create  clustered index a_taxalltable_pk on a_tax_allowance_table (a_tax_allowance_entry_id)*/ 
/* go */
...
/* a_fund_admin_fee */
/* create  clustered index a_fund_admin_fee_pk on a_fund_admin_fee (a_fund, a_ledger_number)*/ 
/* go */
...
/* a_admin_fee_type */
/* create  clustered index a_admin_fee_type_pk on a_admin_fee_type (a_ledger_number, a_admin_fee_type, a_admin_fee_subtype)*/ 
/* go */


/* a_admin_fee_type_tmp */
/* create  clustered index a_admin_fee_type_tmp_pk on a_admin_fee_type_tmp (a_ledger_number, a_admin_fee_type, a_admin_fee_subtype)*/ 
/* go */


/* a_admin_fee_type_item */
/* create  clustered index a_admin_fee_type_item_pk on a_admin_fee_type_item (a_ledger_number, a_admin_fee_type, a_admin_fee_subtype, a_dest_fund)*/ 
/* go */
...
/* create  clustered index a_admin_fee_type_item_tmp_pk on a_admin_fee_type_item_tmp (a_ledger_number, a_admin_fee_type, a_admin_fee_subtype, a_dest_fund)*/ 
/* go */
...
/* a_fund_receipting */
/* create  clustered index a_fund_receipting_pk on a_fund_receipting (a_fund, a_ledger_number)*/ 
/* go */
...
/* create  clustered index a_fund_rcptacct_pk on a_fund_receipting_accts (a_fund, a_ledger_number,a_account_code)*/ 
/* go */
...
/* a_receipt_type */
/* create  clustered index a_rcpttype_pk on a_receipt_type (a_receipt_type)*/ 
/* go */
...
go
/* create  clustered index a_gifttrx_fund_clustered_idx on a_subtrx_gift (a_fund, a_account_code, a_ledger_number, a_batch_number, a_gift_number)*/ 
/* go */
...
go
/* create  clustered index a_gifttrxi_fund_clustered_idx on a_subtrx_gift_item (a_fund, a_account_code, a_ledger_number, a_batch_number, a_gift_number, a_split_number)*/ 
/* go */
...
/* create  clustered index a_rcptno_pk on a_subtrx_gift_rcptcnt (a_ledger_number)*/ 
/* go */
...
go
/* create  clustered index a_fund_auto_subscribe_pk on a_fund_auto_subscribe (a_fund, a_ledger_number, m_list_code)*/ 
/* go */
...
go
/* create  clustered index a_motivational_code_pk on a_motivational_code (a_ledger_number, a_motivational_code)*/ 
/* go */
...
go
/* create  clustered index a_givingp_pk on a_giving_pattern (a_ledger_number, p_donor_partner_key, a_fund, a_pattern_id, a_history_id)*/ 
/* go */
...
go
/* create  clustered index a_givingpa_pk on a_giving_pattern_allocation (a_ledger_number, p_donor_partner_key, a_fund, a_pattern_id, a_history_id)*/ 
/* go */
...
/* create  clustered index a_givingf_pk on a_giving_pattern_flag (a_ledger_number, p_donor_partner_key, a_fund, a_pattern_id, a_history_id)*/ 
/* go */
...
/* a_funding_target */
/* create  clustered index a_target_pk on a_funding_target (a_ledger_number, a_fund, a_target_id)*/ 
/* go */
...
/* create  clustered index a_supptgt_pk on a_support_review_target (a_ledger_number, a_fund, a_target_id, a_review)*/ 
/* go */
...
go
/* create  clustered index a_descr_pk on a_descriptives (a_ledger_number, p_donor_partner_key, a_fund)*/ 
/* go */
...
go
/* create  clustered index a_descrhist_pk on a_descriptives_hist (a_ledger_number, p_donor_partner_key, a_fund, a_hist_id)*/ 
/* go */
...
/* a_subtrx_xfer */
/* create  clustered index a_subtrx_xfer_pk on a_subtrx_xfer (a_ledger_number, a_batch_number, a_journal_number)*/ 
/* go */
...
go
/* create  clustered index a_subtrx_deposit_pk on a_subtrx_deposit (a_ledger_number, a_batch_number)*/ 
/* go */
...
go
/* create  clustered index a_subtrx_cxf_fund_clustered_idx on a_subtrx_cashxfer (a_fund, a_source_cash_acct, a_ledger_number, a_batch_number, a_journal_number)*/ 
/* go */
...
go
/* create  clustered index i_assoc_pk on i_association (i_assoc_service, i_assoc_type, i_assoc_external_id, i_assoc_hist_id)*/ 
/* go */
...
go
/* create  clustered index i_acct_assoc_pk on i_acct_association (a_ledger_number, i_assoc_service, i_assoc_type, i_assoc_external_id, i_assoc_hist_id)*/ 
/* go */
...
go
create  index i_eg_efund_idx on i_eg_gift_import (i_eg_desig_name, a_ledger_number, i_eg_fundmap_future, i_eg_fundmap_confidence, a_fund, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
create  index i_eg_egift_idx on i_eg_gift_import (i_eg_gift_uuid, a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
/* create  clustered index i_eg_gift_import_pk on i_eg_gift_import (a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)*/ 
/* go */
create  index i_eg_kdepbatch_idx on i_eg_gift_import (a_batch_number_deposit, a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
create  index i_eg_kdonfund_idx on i_eg_gift_import (p_donor_partner_key, a_ledger_number, a_fund, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
create  index i_eg_kdonor_idx on i_eg_gift_import (p_donor_partner_key, a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
create  index i_eg_kfeebatch_idx on i_eg_gift_import (a_batch_number_fees, a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
create  index i_eg_kfund_idx on i_eg_gift_import (a_fund, a_account_code, a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
create  index i_eg_kgiftbatch_idx on i_eg_gift_import (a_batch_number, a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
create  index i_eg_postproc_idx on i_eg_gift_import (i_eg_postprocess, a_ledger_number, i_eg_trx_uuid, i_eg_desig_uuid, i_eg_line_item)
go
...
go
/* create  clustered index i_eg_giving_url_pk on i_eg_giving_url (a_ledger_number, a_fund)*/ 
/* go */
...
/* c_message */
/* create  clustered index c_message_pk on c_message (c_chat_id, c_message_id)*/ 
/* go */


/* c_chat */
/* create  clustered index c_chat_pk on c_chat (c_chat_id)*/ 
/* go */
...
/* c_member */
/* create  clustered index c_member_pk on c_member (c_chat_id, s_username)*/ 
/* go */
...
/* go */
create  index t_sprintproj_rev_idx on t_sprint_project (t_sprint_id, t_project_id)
go
...
/* s_user_data */
/* create  clustered index s_user_data_pk on s_user_data (s_username)*/ 
/* go */


/* s_user_loginhistory */
/* create  clustered index s_loginhist_pk on s_user_loginhistory (s_username, s_sessionid)*/ 
/* go */


/* s_subsystem */
/* create  clustered index s_subsystem_pk on s_subsystem (s_subsystem_code)*/ 
/* go */


/* s_process */
/* create  clustered index s_process_pk on s_process (s_subsystem_code, s_process_code)*/ 
/* go */


/* s_process_status */
/* create  clustered index s_procstat_pk on s_process_status (s_subsystem_code, s_process_code, s_process_status_code)*/ 
/* go */


/* s_motd */
/* create  clustered index s_motd_pk on s_motd (s_motd_id)*/ 
/* go */


/* s_motd_viewed */
/* create  clustered index s_motd_viewed_pk on s_motd_viewed (s_motd_id, s_username)*/ 
/* go */
...
/* s_sec_endorsement */
/* create  clustered index s_end_pk on s_sec_endorsement (s_endorsement, s_context, s_subject)*/ 
/* go */


/* s_sec_endorsement_type */
/* create  clustered index s_endt_pk on s_sec_endorsement_type (s_endorsement)*/ 
/* go */


/* s_sec_endorsement_context */
/* create  clustered index s_endc_pk on s_sec_endorsement_context (s_context)*/ 
/* go */


/* s_mykardia */
/* create  clustered index s_myk_pk on s_mykardia (s_username, s_module, s_plugin, s_occurrence)*/ 
/* go */
...
go
/* create  clustered index s_req_pk on s_request (s_request_id)*/ 
/* go */


/* s_request_type */
/* create  clustered index s_reqtype_pk on s_request_type (s_request_type)*/ 
/* go */
...
go
/* create  clustered index s_audit_pk on s_audit (s_sequence)*/ 
/* go */
