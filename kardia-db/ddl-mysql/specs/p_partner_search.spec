...
p_partner_search "application/filespec"
    ...
    annotation = "CSV Data for p_partner_search";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    p_search_id "filespec/column" { type=integer; id=1; }
    p_search_desc "filespec/column" { type=string; id=2; }
    p_search_visibility "filespec/column" { type=string; id=3; }
    p_is_temporary "filespec/column" { type=integer; id=4; }
