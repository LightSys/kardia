$Version=2$
a_account_class "application/filespec"
    {
    // General parameters.
    filetype = csv;
    header_row = yes;
    ...
    annotation = "CSV Data for a_account_class";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    a_account_class "filespec/column" { type=string; id=1; }
    a_ledger_number "filespec/column" { type=string; id=2; }
    a_acct_class_desc "filespec/column" { type=string; id=3; }
