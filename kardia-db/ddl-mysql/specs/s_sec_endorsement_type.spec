...
s_sec_endorsement_type "application/filespec"
    ...
    annotation = "CSV Data for s_sec_endorsement_type";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    s_endorsement "filespec/column" { type=string; id=1; }
    s_endorsement_desc "filespec/column" { type=string; id=2; }
    s_endorsement_context_type "filespec/column" { type=string; id=3; }
