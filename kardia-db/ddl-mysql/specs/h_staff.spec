...
h_staff "application/filespec"
    ...
    annotation = "CSV Data for h_staff";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    p_partner_key "filespec/column" { type=string; id=1; }
    h_is_active "filespec/column" { type=integer; id=2; }
    h_start_date "filespec/column" { type=datetime; id=3; }
    h_staff_role "filespec/column" { type=string; id=4; }
    h_percent_fulltime "filespec/column" { type=double; id=5; }
