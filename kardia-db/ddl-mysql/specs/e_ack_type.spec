$Version=2$
e_ack_type "application/filespec"
    {
    // General parameters.
    filetype = csv;
    header_row = yes;
    ...
    annotation = "CSV Data for e_ack_type";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    e_ack_type "filespec/column" { type=integer; id=1; }
    e_ack_type_label "filespec/column" { type=string; id=2; }
    e_ack_type_desc "filespec/column" { type=string; id=3; }
