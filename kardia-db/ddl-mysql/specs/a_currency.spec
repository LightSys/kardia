...
a_currency "application/filespec"
    ...
    annotation = "CSV Data for a_currency";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    a_ledger_number "filespec/column" { type=string; id=1; }
    a_currency_code "filespec/column" { type=string; id=2; }
    a_currency_desc "filespec/column" { type=string; id=3; }
    a_enabled "filespec/column" { type=integer; id=4; }
