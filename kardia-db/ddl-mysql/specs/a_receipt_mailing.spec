...
a_receipt_mailing "application/filespec"
    ...
    annotation = "CSV Data for a_receipt_mailing";
    key_is_rowid = yes;
    new_row_padding = 8;
    
    // Column specifications.
    a_ledger_number "filespec/column" { type=string; id=1; }
    m_list_code "filespec/column" { type=string; id=2; }
    a_prev_issue_lookback "filespec/column" { type=integer; id=3; }
    a_prev_issue_max_interval "filespec/column" { type=double; id=4; }
